...
class Speaker_encoder_tied(nn.Module):
    def __init__(self, shared_meaning_embedding, vocab_size, embedding_size, max_len, output_size, activation_fn=None):
        super(Speaker_encoder_tied, self).__init__()
