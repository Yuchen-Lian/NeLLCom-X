...
class RLSpeaker_decoder_tied(DecoderRNN):
    def __init__(self, shared_word_embedding, pad_id, *args, **kwargs):
        super(RLSpeaker_decoder_tied, self).__init__(*args, **kwargs)
        self.pad_id = pad_id
