...
from egg.zoo.nellcom_x.archs import Commu_Game2, SpeakerListener
from egg.zoo.nellcom_x.losses import MyLoss
from egg.zoo.nellcom_x.games_lst import build_game_lst
from egg.zoo.nellcom_x.games_spk import build_game_spk
from egg.zoo.nellcom_x.data import MyDataset
...
def build_game_after_supervised(
    ...
    if game_type == 'speak':
        ...
        game2 = Commu_Game2(train_mode=train_mode, spk_lst=spk_lst, loss=loss, train_logging_strategy=train_logging_strategy, spk_entropy_coeff=opts.spk_entropy_coeff)
